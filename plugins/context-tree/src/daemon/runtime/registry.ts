...
export class DaemonRegistryOwner {
  ...
  constructor(
    ...
    this.lockDirectory = join(runtimeDirectory, "daemon-v9.owner.lock");
    this.registryFile = join(runtimeDirectory, "daemon-v9.json");
  }
...
export class DaemonLaunchGate {
  ...
  constructor(runtimeDirectory: string) {
    this.lockFile = join(runtimeDirectory, "daemon-v9.launch.lock");
  }
